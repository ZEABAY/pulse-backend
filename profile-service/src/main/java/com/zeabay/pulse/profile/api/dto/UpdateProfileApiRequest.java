...
@Schema(
    description = "Request body for partially updating a user profile. All fields are optional.")
public record UpdateProfileApiRequest(
    ...
    @Schema(description = "Last name", example = "Doe", minLength = 2, maxLength = 50)
        @Size(min = 2, max = 50)
        String lastName,
    @Schema(description = "Date of birth", example = "1995-06-15") @Past LocalDate dateOfBirth,
