...
/**
 * Infrastructure adapter that persists domain events to the transactional outbox table.
 *
 * <p>Implements {@link OutboxPort} so the service layer remains free of Jackson and R2DBC
