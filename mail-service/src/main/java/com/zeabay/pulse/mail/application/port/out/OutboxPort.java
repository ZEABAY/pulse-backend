package com.zeabay.pulse.mail.application.port.out;
...
public interface OutboxPort {
   ...
   * @param eventType human-readable event type (e.g. "EmailVerificationMailFailed")
   * @param topic Kafka topic name
   * @param aggregateType name of the aggregate root (e.g. "SentMailLog")
